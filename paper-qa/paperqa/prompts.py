...
EVAL_PROMPT_TEMPLATE = (
    "Extract the single letter answer from the following question and answer. Your answer should only be a single letter, do NOT output anything other than a single letter."
    "\n\n{qa_prompt}"
    "\n\n{qa_answer}"
